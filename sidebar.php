				...
				<div class="widget">
	                <h2 class="widget-title"><span><?php esc_html_e( 'Sidebar Widget Area', 'vt-blogging' ); ?></span></h2>
	           		...
	           		<div class="textwidget">
	                  	...
	                  	<p><?php echo esc_html( __( 'By default it will load Search and Archives widgets as shown below. You can add widget to this area by visiting your <a href="%s">Widgets Panel</a> which will replace default widgets.', 'vt-blogging' ), esc_url( admin_url( 'widgets.php' ) ) ); ?></p>
	                 </div>
