			...
			<div class="about-widget widget-content">
				...
				<div class="about-description">
					...
					<div class="social-icons">
					  <ul>
						<li class="facebook"><?php if($facebook != '') echo '<a href="' . esc_url($facebook) . '" title="' . __( 'Facebook', 'vt-blogging' ) . '" target="_blank"> ' . esc_html__( 'Facebook', 'vt-blogging' ) . ' </a>'; ?></li>
						<li class="twitter"><?php if($twitter != '') echo '<a href="' . esc_url($twitter) . '" title="' . __( 'Twitter', 'vt-blogging' ) . '" target="_blank"> ' . esc_html__( 'Twitter', 'vt-blogging' ) . ' </a>'; ?></li>
						<li class="google-plus"><?php if($googleplus != '') echo '<a href="' . esc_url($googleplus) . '" title="' . __( 'Google Plus', 'vt-blogging' ) . '" target="_blank"> ' . esc_html__( 'Google+', 'vt-blogging' ) . ' </a>'; ?></li>
						<li class="youtube"><?php if($youtube != '') echo '<a href="' . esc_url($youtube) . '" title="' . __( 'Youtube', 'vt-blogging' ) . '" target="_blank"> ' . esc_html__( 'YouTube', 'vt-blogging' ) . ' </a>'; ?></li>
						<li class="instagram"><?php if($instagram != '') echo '<a href="' . esc_url($instagram) . '" title="' . __( 'Instagram', 'vt-blogging' ) . '" target="_blank"> ' . esc_html__( 'Instagram', 'vt-blogging' ) . ' </a>'; ?></li>
						<li class="rss"><?php if($feed != '') echo '<a href="' . esc_url($feed) . '" title="' . __( 'Feed', 'vt-blogging' ) . '" target="_blank"> ' . esc_html__( 'RSS', 'vt-blogging' ) . ' </a>'; ?></li>
					  </ul>
					</div>
				</div>
			</div>
